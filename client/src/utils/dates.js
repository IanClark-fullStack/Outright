// On the frontend, // Take in the date in the format of 2022-01-02

// Remove hyphens and convert to a number value 

// Compare values to find the greatest. 


// Reformat the largest value found back to 2022-01-02
...
let dateCompare = dateYesterday.replaceAll('-', '');
